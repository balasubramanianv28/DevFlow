                    ...
                    <div className="mb-2 grid grid-cols-7 gap-1">
                        {[
                            ...
                            (
                                ...
                                <div
                                    key={`${day}-${index}`}
                                    className="flex h-8 items-center justify-center text-[10px] font-semibold uppercase tracking-wide text-white/25"
                                >
                                    {day}
                                </div>
                            )
                ...
                >
                    <div className="space-y-5">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder="INV-001"
                                autoComplete="off"
                                className="h-11 w-full rounded-xl border border-white/[0.08] bg-[#101010] px-4 text-sm text-white placeholder:text-white/20 outline-none transition-all focus:border-orange-500/40 focus:ring-2 focus:ring-orange-500/5"
                            />
                        </div>
                        ...
                        <div className="relative">
                            ...
                            <button
                                ...
                                className={`flex h-11 w-full items-center justify-between rounded-xl border px-4 text-left transition-all ${clientDropdownOpen
                                    ? "border-orange-500/50 bg-[#181818] ring-2 ring-orange-500/5"
                                    : "border-white/[0.08] bg-[#101010] hover:border-white/[0.14]"
                                    }`}
                            >
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        placeholder="0"
                                        className="h-11 w-full appearance-none rounded-xl border border-white/[0.08] bg-[#101010] pl-9 pr-4 text-sm text-white placeholder:text-white/20 outline-none transition-all focus:border-orange-500/40 focus:ring-2 focus:ring-orange-500/5 [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
                                    />
                                </div>
                            </div>
                    ...
                    <div className="mt-7 flex items-center justify-end gap-3 border-t border-white/[0.06] pt-5">
                        ...
                        <button
                            ...
                            disabled={loading}
                            className="rounded-xl px-4 py-2.5 text-sm font-medium text-white/45 transition-all hover:bg-white/[0.05] hover:text-white disabled:cursor-not-allowed disabled:opacity-30"
                        >
                            Cancel
                        </button>
