        ...
        <main className="min-h-screen overflow-hidden bg-[#080808] text-white">
            ...
            <section className="relative flex min-h-screen items-center justify-center px-6 pt-20">
                ...
                <div className="relative z-10 mx-auto max-w-5xl text-center">
                    ...
                    >
                        DEVFLOW brings projects, tasks, clients
                        and team collaboration together in one
                        powerful workspace built for modern teams.
                    </motion.p>
                    ...
                    >
                        ...
                        <button
                            ...
                            className="group flex items-center gap-2 rounded-full bg-[#ff6b2c] px-7 py-3.5 font-semibold text-black transition hover:bg-[#ff8a4c]"
                        >
                            Start building
                        ...
                        <button
                            ...
                            className="rounded-full border border-white/10 px-7 py-3.5 font-semibold text-white transition hover:border-white/20 hover:bg-white/5"
                        >
                            Explore features
                        </button>
                    </motion.div>
            ...
            >
                <div className="mx-auto max-w-6xl">
                    ...
                    <div className="mb-14 text-center">
                        <p className="text-sm font-semibold uppercase tracking-[0.2em] text-[#ff6b2c]">
                            Features
                        </p>
                        ...
                        <p className="mx-auto mt-4 max-w-2xl text-zinc-500">
                            Manage your projects, tasks, clients,
                            invoices and analytics from one
                            powerful workspace.
                        </p>
                    </div>
                        ...
                        {[
                            {
                                title: "Projects",
                                description:
                                    "Plan, organize and track your projects in one place.",
                            },
                            {
                                title: "Tasks",
                                description:
                                    "Manage priorities, deadlines and task progress easily.",
                            },
                            {
                                title: "Clients",
                                description:
                            ...
                            },
                            {
                                title: "Analytics",
                                description:
                                    "Understand your business with clear revenue and activity insights.",
                            },
                        ].map((feature) => (
                            <div
                                key={feature.title}
                                className="rounded-2xl border border-white/10 bg-white/[0.02] p-6 transition hover:border-[#ff6b2c]/30 hover:bg-[#ff6b2c]/5"
                            >
